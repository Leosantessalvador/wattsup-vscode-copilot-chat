...
```
wget https://github.com/Ucodia/wattsup-vscode-copilot-chat/releases/download/v99.6.0/wattsup-copilot-chat-99.6.0.vsix
code --install-extension wattsup-copilot-chat-99.6.0.vsix
```
